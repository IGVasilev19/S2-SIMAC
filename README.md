...
## ⚖️ License
This project is currently unlicensed. Please respect the copyright of the original authors.

---

## <footer>
**S2-SIMAC** | [GitHub Repository](https://github.com/IGVasilev19/S2-SIMAC) | Built with 💙 by IGVasilev19. If you find this project useful, please consider starring ⭐ and forking the repository!
</footer>
