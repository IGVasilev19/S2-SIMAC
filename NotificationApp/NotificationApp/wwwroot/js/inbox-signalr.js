  ...
  connection.on("ReceiveNotification", (notification) => {
    ...
    a.innerHTML = `
      <div class="notification flex h-full w-full items-center justify-center gap-2 p-2 hover:bg-gray-200 hover:rounded-md hover:cursor-pointer">
        <div class="rounded-4xl h-[25px] w-[30px] border ${
          notification.important ? "bg-[#FF3131]" : ""
        }"></div>
      ...
      <div class="h-[8px] w-full rounded-b-md border ${
        notification.Read ? "bg-gray-200" : "bg-[#7AA0FF]"
      }"></div>
    `;
